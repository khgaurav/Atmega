...
class TurtleDrive 
 { public:
   ...
   public:
      TurtleDrive(uint8_t _in1, uint8_t _in2, uint8_t _ena, uint8_t _in3, uint8_t _in4, uint8_t _enb) : in1(_in1), in2(_in2), ena(_ena), in3(_in3), in4(_in4), enb(_enb), isDriving(false) {}
